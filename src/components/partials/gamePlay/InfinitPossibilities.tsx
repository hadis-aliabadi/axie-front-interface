...
export const InfinitPossibilities = () => {
  ...
  return (
    <section id="infinite " className='my-20'>
      ...
      <div className="flex flex-col items-center gap-12 mx-4">
        <p className="text-xl text-center">
          {t('gameplay:infinity_description')}
        </p>
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center w-full lg:max-w-[760px] gap-4">
            {t<string, IBattleTypeData[]>('gameplay:battletype_data', {
              returnObjects: true,
            }).map((item, index) => (
              <LinkComponent
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center w-full lg:max-w-[760px] gap-8">
            {t<string, IBattleTypeData[]>('gameplay:theory_craft_data', {
              returnObjects: true,
            }).map((item, index) => (
              <div
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-col w-full lg:max-w-[760px] gap-8">
              {t<string, IBattleTypeData[]>('gameplay:infiniteExperience', {
                returnObjects: true,
              }).map((item, index) => (
